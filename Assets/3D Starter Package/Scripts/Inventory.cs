...
namespace DigitalWorlds.StarterPackage3D
{
    ...
    public class Inventory : MonoBehaviour
    {
        ...
        //     // IMPORTANT: use false so it respects layout settings
        //     newItem.transform.SetParent(layoutGroup.transform, false);
        ...
        //     // Add AspectRatioFitter so width scales with height
        //     AspectRatioFitter fitter = newItem.AddComponent<AspectRatioFitter>();
        //     fitter.aspectMode = AspectRatioFitter.AspectMode.HeightControlsWidth;

        //     // Optional but recommended: ensure it has a RectTransform
